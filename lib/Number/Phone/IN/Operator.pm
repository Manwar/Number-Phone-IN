package Number::Phone::IN::Operator;

$Number::Phone::IN::Operator::VERSION = '0.01';

=head1 NAME

Number::Phone::IN::Operator - Represents 'Operator' in Indian phone number system.
...
Represents 'Operator' in Indian phone number system.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Number::Phone::IN::Operator
...
1; # End of Number::Phone::IN::Operator
