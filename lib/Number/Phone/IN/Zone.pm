package Number::Phone::IN::Zone;

$Number::Phone::IN::Zone::VERSION = '0.01';

=head1 NAME

Number::Phone::IN::Zone - Represents 'Zone' in Indian phone number system.
...
Represents 'Zone' in Indian phone number system.
