package Number::Phone::IN::STD;

$Number::Phone::IN::STD::VERSION   = '0.01';
$Number::Phone::IN::STD::AUTHORITY = 'cpan:MANWAR';

=head1 NAME

Number::Phone::IN::STD - Represents 'STD' in Indian phone number system.
...
Represents 'STD' in Indian phone number system.
